...
| 2 | Lost scope | work the task owed vanishes or ships wrong | A7, A14, A21, A23, A24, A25, A27, A32, A36 | watermark breaks that hide asks from the next run, tested-field credit dropped by a later segment |

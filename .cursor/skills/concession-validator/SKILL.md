...
- **"needs a product decision" / "awaiting design input" / "recommend product review"** → the orch IS product (operator policy 2026-07-30). Make the call, record it in the report's Decisions section with the rejected alternatives and the trigger that would reopen it, and ship. Copy, naming, UX defaults, thresholds, and error-message wording are all in-task calls, never deferral grounds. DENY. Try: decide + document in Decisions, proceed.
